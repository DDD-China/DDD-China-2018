$(function () {
  ...
  $('.topic-item-2 .speaker-info .speaker-img img').attr('src', speakers[id][1]['producer-img']).attr('alt', speakers[id][1]['producer-name']);
  $('.topic-item-2 .speaker-info .speaker-detail .speaker-detail-introduction .speaker-name').append(speakers[id][1]['producer-name']);
  $('.topic-item-2 .speaker-info .speaker-detail .speaker-detail-introduction .speaker-title').append(speakers[id][1]['producer-introduction']);
  $('.topic-item-2 .speaker-detail .speaker-detail-information').append(speakers[id][1]['producer-information']);
