var producers = [
  ...
  },
  {
    ...
    'producer-information': '季炜为众多客户提供敏捷转型、精益创新及业务流程优化等管理咨询服务，涉及领域包括金融、电信、互联网等领域。季炜对设计思维、需求条目化管理、领域驱动设计、LeSS、Scrum、Kanban等实践有深入了解。目前专注于帮助客户采纳精益和敏捷的原则与方法，提升产品价值，提高研发效率和质量的研究和实践工作。\n',
    ...
    '我们以DDD方法为指导，以领域建模、业务抽象为核心，以分层解耦，可视化为主要策略，结合组件化、可测试接口设计、依赖倒置等技术方法对架构进行重构，以达到控制系统复杂度的目的，从而使产品具有高可扩展、并行研发、可持续交付的特性；\n' +
    '一年多来，架构重构完成了多业务模块的业务建模、边界定义，支撑了云、人工智能技术的引入；实现了10+特性团队并行研发，产品整体发布周期缩短到1~3个月，单业务实现2~3周独立发布，有效支撑了业务发展及产品转型；同时驱动组织结构向外科手术式团队转型；',
  },
    {
    'producer-img': '../resource/xupo.jpeg',
    'producer-name': '徐泼',
    'producer-introduction': '美团/酒旅研发中心高级技术专家',
